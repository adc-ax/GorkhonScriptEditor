...
{
    class CInstructionLT : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {

        public CInstructionLT(List<Object> args, List<byte> bin)
        {
            OPCode = 0x29;
            Args = args;
            DisplayString = ("LT [" + Args[0].ToString() + "], [" + Args[1].ToString() + "]");
