...
{
    class CInstructionLT2 : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {

        public CInstructionLT2(List<Object> args, List<byte> bin)
        {
            OPCode = 0x3B;
            Args = args;
            DisplayString = ("LT2 [" + Args[1].ToString() + "], [" + Args[0].ToString() + "] -> [" + Args[2].ToString() + "], POP " + Args[3].ToString());
