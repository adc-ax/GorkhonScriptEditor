...
{
    class CInstructionPushF : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionPushF(List<Object> args, List<byte> bin)
        {
            OPCode = 0x13;
            Args = args;
            DisplayString = ("PUSH<float> " + Args[0].ToString());
