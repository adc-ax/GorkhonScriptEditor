...
{
    class CInstructionPushI : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionPushI(List<Object> args, List<byte> bin)
        {
            OPCode = 0x12;
            Args = args;
            DisplayString = ("PUSH<int> " + Args[0].ToString());
