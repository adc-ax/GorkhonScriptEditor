...
{
    class CInstructionGT2 : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {

        public CInstructionGT2(List<Object> args, List<byte> bin)
        {
            OPCode = 0x3C;
            Args = args;
            DisplayString = ("GT [" + Args[1].ToString() + "], [" + Args[0].ToString() + "] -> [" + Args[2].ToString() + "]");
