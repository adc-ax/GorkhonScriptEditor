...
{
    class CInstructionLE : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {

        public CInstructionLE(List<Object> args, List<byte> bin)
        {
            OPCode = 0xBC;
            Args = args;
            DisplayString = ("LE [" + Args[0].ToString() + "], [" + Args[1].ToString() + "]");
