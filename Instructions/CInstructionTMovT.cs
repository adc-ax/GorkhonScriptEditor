...
{
    class CInstructionTMovT : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionTMovT(List<Object> args, List<byte> bin)
        {
            OPCode = 0xD;
            Args = args;
            DisplayString = ("MOV taskVar #" + Args[0].ToString() + " -> taskVar #" + Args[1].ToString());
