...
{
    class CInstructionTaskCall : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionTaskCall(List<Object> args, List<byte> bin)
        {
            OPCode = 0x51;
            Args = args;
            DisplayString = ("TASKCALL " + Args[0].ToString());
