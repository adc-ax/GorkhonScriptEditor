...
{
    class CInstructionDiv2 : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionDiv2(List<Object> args, List<byte> bin)
        {
            OPCode = 0x34;
            Args = args;
            DisplayString = ("DIV [" + Args[0].ToString() + "] / [" + Args[1].ToString() + "] -> [" + Args[2].ToString() + "], POP " + Args[3].ToString());
