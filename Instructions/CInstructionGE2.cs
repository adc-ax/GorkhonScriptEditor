...
{
    class CInstructionGE2 : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {

        public CInstructionGE2(List<Object> args, List<byte> bin)
        {
            OPCode = 0x3E;
            Args = args;
            DisplayString = ("GE [" + Args[1].ToString() + "], [" + Args[0].ToString() + "] -> [" + Args[2].ToString() + "], POP " + Args[3].ToString());
