...
{
    class CInstructionPushB : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionPushB(List<Object> args, List<byte> bin)
        {
            OPCode = 0x11;
            Args = args;
            DisplayString = ("PUSH<bool> " + Args[0].ToString());
