...
{
    class CInstructionNot2 : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionNot2(List<Object> args, List<byte> bin)
        {
            OPCode = 0x42;
            Args = args;
            DisplayString = ("NOT stack[" + Args[0].ToString() + "] into stack[" + Args[1].ToString() + "] w/ param " + Args[2].ToString());
