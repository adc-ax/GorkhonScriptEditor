...
{
    class CInstructionEq2 : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionEq2(List<Object> args, List<byte> bin)
        {
            OPCode = 0x29;
            Args = args;
            DisplayString = ("EQ [" + Args[0].ToString() + "], [" + Args[1].ToString() + "]  -> [" + Args[2].ToString() + "]");
