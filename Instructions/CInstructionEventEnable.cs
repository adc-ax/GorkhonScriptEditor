...
{
    class CInstructionEventEnable : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionEventEnable(List<Object> args, List<byte> bin)
        {
            OPCode = 0x56;
            Args = args;
            DisplayString = ("EVENTENABLE " + Args[0].ToString());
