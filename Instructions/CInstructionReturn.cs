...
{
    class CInstructionReturn : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionReturn(List<Object> args, List<byte> bin)
        {
            OPCode = 0x50;
            Args = args;
            DisplayString = ("RET +POP " + Args[0].ToString());
