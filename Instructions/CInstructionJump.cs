...
{
    class CInstructionJump : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionJump(List<Object> args, List<byte> bin)
        {
            OPCode = 0x0E;
            Args = args;
            DisplayString = ("JUMP 0x" + ((int)Args[0]).ToString("X2"));
