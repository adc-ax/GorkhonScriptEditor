...
{
    class CInstructionLE2 : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {

        public CInstructionLE2(List<Object> args, List<byte> bin)
        {
            OPCode = 0x3D;
            Args = args;
            DisplayString = ("LE2 [" + Args[1].ToString() + "], [" + Args[0].ToString() + "] -> [" + Args[2].ToString() + "], POP " + Args[3].ToString());
