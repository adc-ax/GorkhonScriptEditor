...
{
    class CInstructionCall : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionCall(List<Object> args, List<byte> bin)
        {
            OPCode = 0x4F;
            Args = args;
            DisplayString = ("CALL " + ((Int32)Args[0]).ToString("X4"));
