...
{
    class CInstructionTObjFunc : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionTObjFunc(List<Object> args, List<byte> bin)
        {
            OPCode = 0x55;
            Args = args;
