...
{
    class CInstructionMod2 : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionMod2(List<Object> args, List<byte> bin)
        {
            OPCode = 0x35;
            Args = args;
            DisplayString = ("MOD [" + Args[0].ToString() + "], [" + Args[1].ToString() + "] -> [" + Args[2].ToString() + "], POP " + Args[3].ToString());
