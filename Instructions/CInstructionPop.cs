...
{
    class CInstructionPop : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IInstruction
    {
        public CInstructionPop(List<Object> args, List<byte> bin)
        {
            OPCode = 0x1A;
            Args = args;
            DisplayString = ("POP " + Args[0].ToString());
